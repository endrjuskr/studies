...
public class ArgNode extends Arg {
  public final Type type_;
  public final String ident_;

  public ArgNode(Type p1, String p2) { type_ = p1; ident_ = p2; }

  public <R,A> R accept(Latte.Absyn.Arg.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof Latte.Absyn.ArgNode) {
      Latte.Absyn.ArgNode x = (Latte.Absyn.ArgNode)o;
