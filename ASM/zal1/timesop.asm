...
calculateexp:		mov rax, qword [expa]			; adding two exponents 
					...
					mov rax, qword [expb]
					add qword [exp], rax
					add qword [exp], 1023			; add base, becase there will be only normalization in the future

comperingexp:		cmp qword [exp], 2047
					jl normalize
					mov qword [exp], 2047
